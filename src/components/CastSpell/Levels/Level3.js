        ...
        <section className='spell-section'>
                ...
                <div className='spell3-animation'>
                    ...
                    <div className='candle1'>
                        <img className={this.state.success ? 'candle-on' : 'candle-off'} src="https://pngimg.com/uploads/candle/candle_PNG7276.png" alt=""/>
                        <img className={this.state.success ? 'candle-off' : 'candle-on'} src={require('./candle-out.png')} alt=""/>
